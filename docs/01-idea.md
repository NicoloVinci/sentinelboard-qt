...
Perché è utile
Il sistema permette di visualizzare temperatura, umidità, distanza, movimento e luminosità in una sola interfaccia. Questo rende più facile controllare lo stato di un ambiente, rilevare anomalie e registrare uno storico esportabile in CSV. Il progetto è utile anche dal punto di vista didattico perché unisce acquisizione dati, comunicazione seriale, visualizzazione grafica e organizzazione software modulare.
